...
export const Header = () => {
    return (
        <motion.header
            ...
            className="flex items-center justify-between px-6 py-4 bg-white/70 border-b border-black/5 backdrop-blur-xl"
        >
            <div className="flex items-center gap-3">
                <div className="w-2.5 h-2.5 rounded-full bg-accent shadow-[0_0_12px_rgba(var(--accent-rgb),0.35)]" />
            ...
            <div className="flex items-center gap-4">
                ...
                <button
                    type="button"
                    className="w-9 h-9 rounded-full bg-white/70 border border-black/5 shadow-sm flex items-center justify-center text-text-secondary cursor-pointer hover:text-text-primary hover:bg-white transition-colors"
                    aria-label="Settings"
                >
