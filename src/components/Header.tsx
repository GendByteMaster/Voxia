...
export const Header = () => {
    return (
        <motion.header
            ...
            className="flex items-center justify-between px-6 py-4 bg-surface-card border-b border-surface-hover"
        >
            ...
            <div className="flex items-center gap-4">
                ...
                <div className="w-8 h-8 rounded-full bg-surface-hover flex items-center justify-center text-text-secondary cursor-pointer hover:text-text-primary transition-colors">
